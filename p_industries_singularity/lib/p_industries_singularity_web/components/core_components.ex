defmodule P.Industries.Singularity.Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(P.Industries.Singularity.Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(P.Industries.Singularity.Web.Gettext, "errors", msg, opts)
    end
  end
