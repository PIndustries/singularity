defmodule PIndustriesSingularity.TicketsTest do
  use PIndustriesSingularity.DataCase

  alias PIndustriesSingularity.Tickets

  describe "tickets" do
    alias PIndustriesSingularity.Tickets.Ticket

    import PIndustriesSingularity.TicketsFixtures
